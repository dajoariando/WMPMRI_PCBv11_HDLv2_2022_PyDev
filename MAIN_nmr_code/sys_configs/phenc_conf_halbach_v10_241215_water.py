...
# halbach8 v03 that contains 30 turns rx solenoid coil, 2 turn gradient coils for x and z, 4 turns tx coil
    ...
    refill_mult = 3.00 # the refill multiplication to compensate RF loss
    ...
    # cpmg settings
    cpmg_freq = 9.023 # 4.355 # 4.158 # 4.164 # in MHz
    bstrap_pchg_us = 2000
    lcs_pchg_us = 20
    lcs_dump_us = 100
    ...
    vvarac = -0.325 # -1.87 # set to -1.91V # more negative, more capacitance
