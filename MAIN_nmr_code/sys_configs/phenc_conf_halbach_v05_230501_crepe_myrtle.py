class phenc_conf_halbach_v05_230501_crepe_myrtle():
...
# halbach8 v03 that contains 30 turns rx solenoid coil, 2 turn gradient coils for x and z, 4 turns tx coil
    ...
    # cpmg settings
    cpmg_freq = 4.201 # 4.164 # in MHz    bstrap_pchg_us = 2000
    bstrap_pchg_us = 2000
    lcs_pchg_us = 20
    lcs_dump_us = 100
    ...
    p180_dtcl = p90_dtcl
    echoshift_us = 4
    echotime_us = 100 # 140 or 70
    scanspacing_us = 1000000 # normally 100000 for doped water
    samples_per_echo = 600 # 1200 or 400
    echoes_per_scan = 1600 # 400 or 900
