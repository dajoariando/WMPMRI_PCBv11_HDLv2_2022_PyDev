...
# halbach8 v03 that contains 30 turns rx solenoid coil, 2 turn gradient coils for x and z, 4 turns tx coil
    ...
    p180_dtcl = p90_dtcl
    echoshift_us = 9
    echotime_us = 100 # 400 or 70
    scanspacing_us = 40000 # normally 100000 for doped water
    samples_per_echo = 400 # 1000, 600, 200, 100
    echoes_per_scan = 200 # 280 for water, 400 for oil
    n_iterate =  16 # do not change it here for
    ...
    dummy_scan_num = 8 # the dummy_scan_num added dummy scans at before measurement scans in order to have consistent measurement (same T1) across all scans
