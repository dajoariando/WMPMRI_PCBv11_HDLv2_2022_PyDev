class phenc_conf_halbach_v03_240810_oil():
...
# halbach8 v03 that contains 30 turns rx solenoid coil, 2 turn gradient coils for x and z, 4 turns tx coil
    ...
    p180_p90_fact = 2.4 # 2.0 # multiplication factor between p90 to p180 length
    ...
    # cpmg settings
    cpmg_freq = 4.361 # 4.158 # 4.164 # in MHz
    bstrap_pchg_us = 2000
    lcs_pchg_us = 20
    lcs_dump_us = 100
    ...
    p180_dtcl = p90_dtcl
    echoshift_us = 13
    echotime_us = 300 # 400 or 70
    scanspacing_us = 300000 # normally 100000 for doped water
    ...
    sel_adc_ch = 0 # select the adc channel # for NMR to be processed. Input 0 to 7
    ...
    a_est = [30,10] # array of amplitude estimate for fitting
    t2_est = [20e-3,10e-3] # array of t2 estimate for fitting
