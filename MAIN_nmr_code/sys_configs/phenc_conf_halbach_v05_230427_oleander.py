class phenc_conf_halbach_v05_230427_oleander():
# this configuration is for:
# halbach8 v03 that contains 30 turns rx solenoid coil, 2 turn gradient coils for x and z, 4 turns tx coil

    # pulse parameters
    plen_base = 3.00 # 4.00 # the precharging length base. Don't forget to set the corresponding p90_us
    ...
    # cpmg settings
    cpmg_freq = 4.194 # 4.164 # in MHz    bstrap_pchg_us = 2000
    bstrap_pchg_us = 2000
    lcs_pchg_us = 20
    lcs_dump_us = 100
    p90_pchg_us = plen_base
    p90_pchg_refill_us = plen_base*refill_mult
    p90_us = 10 # 6.00, 10.00, 18.00, 24.00
    ...
    p180_dtcl = p90_dtcl
    echoshift_us = 9
    echotime_us = 150 # 140 or 70
    scanspacing_us = 1000000 # normally 100000 for doped water
    samples_per_echo = 800 # 1200 or 400
    echoes_per_scan = 500 # 400 or 900
    n_iterate =  1 # do not change it here for
