class phenc_conf_halbach_v03_230420_tempsens():
...
# halbach8 v03 that contains 30 turns rx solenoid coil, 2 turn gradient coils for x and z, 4 turns tx coil
    ...
    p180_dtcl = p90_dtcl
    echoshift_us = 7
    echotime_us = 200 # 140 or 70
    scanspacing_us = 100000 # normally 100000 for doped water
    samples_per_echo = 1600 # 1200 or 400
    echoes_per_scan = 200 # 400 or 900
    ...
    gradz_volt = 3.0 # the gradient can be positive or negative
    gradx_len_us = 800 # gradient pulse length
    gradx_volt = 3.0 # the gradient can be positive or negative
    grad_refocus = 1 # put 1 to refocus the gradient
    flip_grad_refocus_sign = 0 # put 1 to flip the gradient refocusing sign
    ...
    a_est = [20] # array of amplitude estimate for fitting
